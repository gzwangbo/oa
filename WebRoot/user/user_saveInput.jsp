            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td><s:select name="departmentId" class="SelectStyle" list="#departments" listKey="id" 
                        listValue="name" headerValue="请选择部门">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><s:select name="roleId" list="#roles" multiple="true" headerKey="请给用户赋予角色"  size="10" class="SelectStyle"
